...
export default function Navbar() {
  return (
    <nav className="flex sticky sm:justify-center content-center h-14 border-b-2 border-gray-200">
      <div className="flex justify-evenly items-center w-2/3">
        <h1 className="sm:text-2xl font-Pacifico">Instagram</h1>
        
        <input className="border border-gray-300 bg-white text-center h-7 px-2 rounded-lg text-sm focus:outline-none" type="text" placeholder="Search" />
